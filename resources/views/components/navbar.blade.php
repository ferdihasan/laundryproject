<nav class="navbar navbar-expand-lg  bg-primary shadow mb-3" data-bs-theme="dark">
    <div class="container">
        <a class="navbar-brand" href="/">Ferdi Laundry</a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse d-flex navbar-collapse justify-content-between" id="navbarNav">
        <ul class="navbar-nav">
            <li class="nav-item">
            ...
            <li class="nav-item">
                <form action="/" method="post">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="search" placeholder="Masukan ID Laundry" aria-label="search" aria-describedby="basic-addon1">
